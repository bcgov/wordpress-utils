...
class Standards
{
    ...
    public static function promptUserAboutUpgrade(Event $event): int
    {
        ...
        $upgrade_message = [
            ...
            ' ',
            '<info>The default version is set to "@dev". However, it is recommended to',
            'change this to "2.0" to avoid unexpected errors and warnings that',
            'might occur due to a major version upgrade.',
            '**Upgrade Instructions**: Set your version number to 2.0 in',
            'the "require-dev" section of your composer.json file.',
            '**Downgrade Instructions**: Although not recommended, if you wish to downgrade,',
            'set your version number to 1.1.1 in the "require-dev" section of your composer.json file.',
